...
public class PixelMatching {

    public static void main(String[] args) {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        Mat source, template;
        //将文件读入为OpenCV的Mat格式
        source = Imgcodecs.imread("C:\\Users\\Administrator\\Desktop\\1.png");
        template = Imgcodecs.imread("C:\\Users\\Administrator\\Desktop\\2.png");
        //创建于原图相同的大小，储存匹配度
        ...
        //将结果输出到对应位置
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\3.jpeg", source);
    }
